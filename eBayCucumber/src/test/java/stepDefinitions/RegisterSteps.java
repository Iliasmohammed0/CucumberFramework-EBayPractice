...
public class RegisterSteps {
    ...
    System.setProperty("webdriver.chrome.driver","Q:\\eBayBDD\\eBayCucumber\\Driver\\chromedriver.exe");
    ...
    public void put_first_name() throws Throwable {
        driver.findElement(By.id("firstname")).sendKeys("Ilias");
    }

    @Then("^put last name$")
    public void put_last_name() throws Throwable {
        driver.findElement(By.id("lastname")).sendKeys("Mohammed");
    }

    @Then("^provide email$")
    public void provide_email() throws Throwable {
        driver.findElement(By.id("email")).sendKeys("iliasmohammed0@gmail.com");
    }
